...
def load_frameowrk(mask_path, mask_round, gamma, steps, seed, disable_debugging_API, num_workers, config_path, checkpoint_folder, reduce_train_dataset, standing_statistics,
    ...
    if mask_path is not None:
        ...
        Gen, gen_masks = pruning_generate_extract(Gen, g_checkpoint['state_dict'], initial_G_weigh t, parallel)
        if ema:
