...
def load_frameowrk(seed, gamma, steps, disable_debugging_API, num_workers, config_path, checkpoint_folder, reduce_train_dataset, standing_statistics,
    ...
    print("DIS STATE DICT")
    print(Dis.state_dict())
    if ema:
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=False, pin_memory=True, num_workers=num_workers, drop_last=True)
