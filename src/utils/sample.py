...
def sample_latents(dist, batch_size, dim, truncated_factor=1, num_classes=None, perturb=None, device=torch.device("cpu"), sampler="default"):
    if num_classes:
        if sampler == "default":
            ...
            indices = np.array([555,569,670,405,5,6,7,8,555,569,670,405,5,6,7,8,555,569,670,405,5,6,7,8,555,569,670,405,5,6,7,8,555,569,670,405,5,6,7,8,555,569,670,405,5,6,7,8])[:num_classes_plot]
